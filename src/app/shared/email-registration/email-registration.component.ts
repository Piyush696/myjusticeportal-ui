...
export class EmailRegistrationComponent implements OnInit, OnChanges {
  ...
  createFormControl() {
    this.registrationForm = this.fb.group({
      firstName: ['', [Validators.required, Validators.maxLength(50), Validators.pattern('^[a-zA-Z!@#$%\^&*)(+=._-]*$')]],
      lastName: ['', [Validators.required, Validators.maxLength(50), Validators.pattern('^[a-zA-Z!@#$%\^&*)(+=._-]*$')]],
      middleName: [''],
